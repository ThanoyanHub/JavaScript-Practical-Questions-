...
3. Write another single comment which says, _Welcome to learn Javascript_
Answer
```js
// _Welcome to learn Javascript_
```

5. Write a multiline comment which says, _comments can make code readable, easy to reuse_
   _and informative_
Answer
``js
// _comments can make code readable, easy to reuse_
  //_and informative_
``
7. Create a variable.js file and declare variables and assign string, boolean, undefined and null data types
Answer
```js
...
let city;
```
8. Declare four variables with assigned values
Answer
```js
let name="Thanoyan";
let age=20;
...
10. Declare variables to store your first name, last name, marital status, country and age in multiple lines
Answer
```js
...
let age = 20;
```
12. Declare variables to store your first name, last name, marital status, country and age in a single line
Answer
```js
let firstName = "Gemini", lastName = "Flash", maritalStatus = "Single", country = "The Cloud", age = 3;
```
14. Declare two variables _myAge_ and _yourAge_ and assign them initial values and log to the browser console.
...
```
3. Print the string on the browser console using __console.log()__
Answer
```js
let challenge = 'learn Javascript';
...
```
6. Change all the string characters to lowercase letters using __toLowerCase()__ method
Answer
```js
let challenge = 'learn Javascript';
console.log(challenge.toLowerCase());
```
8. Cut (slice) out the first word of the string using __substr()__ or __substring()__ method
Answer
```js
let challenge = 'learn Javascript';
...
11. Split the string learn Javascript at the space using __split()__ method
Answer
```js
let challenge = 'learn Javascript';
